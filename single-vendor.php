...
?>
    ...
    $vendor = json_decode(htmlspecialchars_decode($_POST['vendor']));
    $name = $vendor->fname . " " . $vendor->lname;
    $select_orders = "SELECT * FROM orders where person='$name' and type='Purchase' order by invoice_no desc;";
    $rows = [];
    ...
    <div class="container-fluid single-vendor">
        <ol class="breadcrumb my-4">
            <li class="breadcrumb-item"><a href="dashborad.php">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="list-vendors.php">Vendors</a></li>
            <li class="breadcrumb-item active"><?php echo $vendor->fname . " " . $vendor->lname; ?></li>
        </ol>
        <div class="row">
            <div class="col-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="data mt-4">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-12"><?php echo $vendor->fname . " " . $vendor->lname; ?></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-lg-4 col-12 pr-0">Business:</div>
                                <div class="col-lg-8 col-12"><?php echo $vendor->company_business; ?></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-lg-4 col-12 pr-0">Email:</div>
                                <div class="col-lg-8 col-12"><?php echo $vendor->email; ?></div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-lg-4 col-12 pr-0">Number:</div>
                                <div class="col-lg-8 col-12"><?php echo $vendor->number; ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-8">
                <div class="card" style="border-radius:0;border:0;box-shadow:0px 0px 5px #33333333">
                    <div class="card-body">
                        <h6>Address</h6>
                        <?php echo $vendor->address[0]; ?>,
                        <?php echo $vendor->address[1]; ?>,
                        <?php echo $vendor->address[2]; ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <?php if ($_SESSION['logged_in'][1] == "1000") { ?>
            <form action="deleting-vendor.php" method="POST">
                <input type="hidden" name="id" value="<?php echo $vendor->id; ?>">
                <button class="btn btn-danger btn-lg btn-block" type="submit">Delete vendor</button>
            </form>
        <?php } ?>
    </div>
    ...
    <div class="custom-modal my_modal" id="edit-info">
        <div class="my_popup">
            <h1>Edit Info</h1>
            <form action="editing-vendors.php" class="add-edit-vendors" method="POST">
                <input type="hidden" name="id" value="<?php echo $vendor->id; ?>">
                <div class="form-group mt-3">
                    <label for="name">Name</label>
                    <div class="row">
                        <div class="col-6">
                            <input type="text" required class="form-control" name="fname" value="<?php echo $vendor->fname; ?>">
                        </div>
                        <div class="col-6">
                            <input type="text" required class="form-control" name="lname" value="<?php echo $vendor->lname; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group mt-4">
                    <label for="business">Company Business</label>
                    <input type="text" required name="company_business" class="form-control" value="<?php echo $vendor->company_business; ?>">
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" class="form-control" value="<?php echo $vendor->email; ?>">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group">
                            <label for="number">Number</label>
                            <input type="number " required name="number" class="form-control" value="<?php echo $vendor->number; ?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="address">Address</label>
                    <input type="text" required name="address[]" class="mb-3 form-control" value="<?php echo $vendor->address[0]; ?>">
                    <input type="text" required name="address[]" class="mb-3 form-control" value="<?php echo $vendor->address[1]; ?>">
                    <input type="text" required name="address[]" class="mb-3 form-control" value="<?php echo $vendor->address[2]; ?>">
                </div>
                <div class="form-group">
